...
HttpProbe.prototype.attach = function(name, target) {
  ...
  if (name == 'http') {
    ...
    aspect.before(target.Server.prototype, methods, function(
      obj,
      methodName,
      args,
      probeData
      ...
      aspect.aroundCallback(args, probeData, function(obj, args, probeData) {
        ...
        if (traceUrl !== '') {
          ...
          aspect.after(res, 'end', probeData, function(
            obj,
            methodName,
            args,
            probeData,
...
HttpProbe.prototype.metricsEnd = function(
  probeData,
  method,
  url,
  res,
...
HttpProbe.prototype.requestEnd = function(
  probeData,
  method,
  url,
  res,
