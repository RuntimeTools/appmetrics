 ...
 */
var typeToMethods = { createPushQueue: ['publish'], createPullQueue : ['on', 'addListener'],
                      createPubQueue: ['publish'], createSubQueue : ['on', 'addListener'] };

var typeToEventType = { createPushQueue: 'push', createPullQueue : 'pull',
    createPubQueue: 'pub', createSubQueue : 'sub' };
