...
function showBuildWarning() {
  ...
  console.log('You are about to build a load of binaries. If this build errors, make sure you have the node-gyp pre-requisites \(https://github.com/nodejs/node-gyp#installation). If you have them and the build still errors, see if there are any related issues at https://github.com/RuntimeTools/appmetrics/issues). If there aren\'t, feel free to open a new issue to report the bug.');
  console.log('********************************************************************************');
  console.log('\n');
};
