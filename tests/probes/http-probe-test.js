...
function checkHttpData(data, t) {
    ...
    t.equals(
            data.hasOwnProperty('duration'), true,
            "Should have HTTP property duration;")
    t.equals(
            data.hasOwnProperty('header'), true,
            "Should have HTTP property header;")
    t.equals(
            data.hasOwnProperty('statusCode'), true,
            "Should have HTTP property statusCode;")
    t.equals(
            data.hasOwnProperty('contentType'), true,
            "Should have HTTP property contentType;")
    t.equals(
            data.hasOwnProperty('requestHeader'), true,
